...
public class DaisyHelper extends SQLiteOpenHelper {
	// when we change database_version, it can only go up. When change it back
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		// if we need onUpgrade to be executed, we need to update the db version
